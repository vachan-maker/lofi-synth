...
const ReasonCard = React.memo(({ reason, index }) => (
    <motion.div
        initial={{ opacity: 0, y: 50 }}
        whileInView={{ opacity: 1, y: 0 }}
        viewport={{ once: true, margin: "-100px" }}
        transition={{ duration: 0.8, delay: index * 0.1 }}
        className="bg-[#fafaff] flex flex-row p-6 rounded-xl gap-8 shadow-lg items-center"
    >
...
export default React.memo(WhyLofiSynth);