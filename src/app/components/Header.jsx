...
export default function Header() {
    return (
        ...
        <Link href="/login"><button className=" bg-gradient-to-r from-purple-500 to-pink-500 text-white py-2 px-6 rounded-full cursor-pointer shadow-md hover:scale-95">Login</button></Link>
        </header>
    )
}