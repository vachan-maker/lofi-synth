        ...
        <>
            <div className="py-20">
                ...
                <input
                    ...
                    class="hidden"
                />
                <button className="cursor-pointer bg-gradient-to-r from-blue-400 to-pink-500 text-white font-semibold py-2 px-4 rounded-lg shadow-md hover:scale-95 ml-5">Let's Go!</button>
                </div>
                </div>
            </div>
        </>
